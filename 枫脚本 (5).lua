...
local Window = OrionLib:MakeWindow({Name = "开源死马中心", HidePremium = false, SaveConfig = true,IntroText = "枫脚本", ConfigFolder = "枫脚本"})

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "枫脚本"; Text ="枫脚本"; Duration = 4; })
